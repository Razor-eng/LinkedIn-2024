...
const ProfilePopup = ({ open, user }) => {
    const navigate = useNavigate();

    return (
        <div className="relative">
            <div className={`${open ? 'block' : 'hidden'} z-50 bg-white w-[200px] border border-[#a8a8a8] flex justify-center absolute mt-1 right-[-50px] px-4 pb-4 flex-col`}>
